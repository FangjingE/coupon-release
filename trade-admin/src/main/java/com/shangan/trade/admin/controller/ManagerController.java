...
//    private CouponFeignClient couponFeignClient;
    ...
    public String addCouponBatchAction(@RequestParam("batchName") String batchName,
        ...
        try {
            ...
            com.shangan.trade.coupon.db.model.CouponBatch couponBatch = new CouponBatch();
    ...
    public ModelAndView sendCouponSynWeb(@RequestParam("batchId") long batchId, @RequestParam("userId") long userId) {
